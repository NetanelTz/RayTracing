...
public class LightsTests {
    ...
    /**
     * Produce a picture of a sphere lighted by a multi lights
     */
    @Test
    public void multiLightSphere() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        ...
        scene.addGeometries(
                new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 100), 50, new Point3D(0, 0, 50)));
        scene.addLights(new DirectionalLight(new Color(500, 300, 0), new Vector(-50, 100, -50)),
                new PointLight(new Color(500, 300, 0), new Point3D(-50, 200, -80), 1, 0.00001, 0.000001),
                new SpotLight(new Color(500, 300, 0), new Point3D(-50, 50, -50),
                        new Vector(-1, -1, 80), 1, 0.00001, 0.00000001));
    ...
    /**
     * Produce a picture of a two triangles lighted by a multi light
     */
    @Test
    public void multiLightTriangle() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        ...
        scene.addLights(new DirectionalLight(new Color(300, 150, 150), new Vector(0, 0, 1)),
                new PointLight(new Color(500, 250, 250), new Point3D(-30, 20, 130), 1, 0.0005, 0.0005),
                new SpotLight(new Color(500, 250, 150), new Point3D(80, 20, 130),
